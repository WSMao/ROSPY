...
//        digitalWrite(LED,HIGH);
        ledcAnalogWrite(LEDC_CHANNEL_5, flash_bright);
      }
      else{
        isLed=false;
//        digitalWrite(LED,LOW);
      ...
      Serial.print("esp32: get switch!\t value:");Serial.println(value);
    }
    else if(!strcmp(variable, "flash_bright")){
      flash_bright=val;
      if(isLed){
        ledcAnalogWrite(LEDC_CHANNEL_5, flash_bright);
      }
      Serial.print("esp32: get slider1!\t value:");Serial.println(value);
    }
    else if(!strcmp(variable, "move")){
      espSend(esp32_cmd,"move",value);
      Serial.print("esp32: get slider1!\t value:");Serial.println(value);
    }
    else if(!strcmp(variable, "turn")){
      espSend(esp32_cmd,"turn",value);
      Serial.print("esp32: get slider2!\t value:");Serial.println(value);
    }
